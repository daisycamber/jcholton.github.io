...
<div align="center">
  ...
  <tr>
    ...
    <td width="488" valign="top"><div align="right"><?php
	  ...
	  foreach ($arr0 as &$value) {
	   echo "<img src=\"./images/nums/".$value.".gif\">";
	  } 
      ?>
	</div></td>
    </tr>
  <tr>
    <td valign="top" bgcolor="#000000"><div align="left"><h2 align="center" class="style16"><?php echo $correct; ?> problems correct <br />
      ...
      <?php echo $total_num; ?> total problems.    </h2>
        <p align="center" class="style17"><input type="text" size="5" name="d2">
        </p>
  ...
  <tr>
    ...
    <td><div align="right">
      ...
      <input name="answerF" type="text" id="answerF" onfocus="hidediv();" size="10"  autocomplete="off"/>
      <?php } else { 
	  			if ($ansR > 0) {
	  ?>
      Q : <input name="answerF" type="text" id="answerF" onfocus="hidediv();" size="5"  autocomplete="off"/>
      R : <input name="answerFR" type="text" id="answerFR" size="5"  autocomplete="off"/>
      <?php } else { ?>
      Q : <input name="answerF" type="text" id="answerF" onfocus="hidediv();" size="10"  autocomplete="off"/>
      <input name="answerFR" type="hidden" value="0" />
      <?php } ?>
      <?php } ?>
    </div></td>
    </tr>
    <tr><td colspan="3"><div align="center">
      <input type="submit" name="submit2" id="button" value="Submit" />
    </div></td></tr>
</table>
  </form>
        <script> 
...
?>
  ...
  <tr>
    ...
    <td><div align="center"><span class="style11">CORRECT</span></div></td>
    <td bgcolor="#000000"><div align="center"><img src="images/frwrks.gif" alt="Yay!" width="72" height="54" /></div></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td><div align="center"><span class="style9">WRONG!!</span></div></td>
    <td bgcolor="#000000"><div align="center"><img src="images/Sad03.gif" alt="Yay!" width="72" height="54" /></div></td>
  </tr>
</table>
...
<br /><br />
<h2><font color="#FF0000">Incorrect Problems / Program Settings<h2><br />
  ...
  <div align="center">
    <table width="400" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="center"><a href="http://sourceforge.net/donate/index.php?group_id=257198"><img src="http://images.sourceforge.net/images/project-support.jpg" width="88" height="32" border="0" alt="Support This Project" /> </a></div></td>
        </tr>
        <tr>
          <td colspan="3"><div align="center" class="style18">I develop this software as a way to contribute to the education of children who need help with their basic math skills. As always this software will be available free of charge, but if you find it useful donations would be very welcome. I will in turn donate 5% of anything donated to myself to Sourceforge.Net and any remaining monies will be used to better this software and the quality of life of my daughter. Thank you for your interest in this project.</div></td>
        </tr>
      </table>
  </div>
</form>
