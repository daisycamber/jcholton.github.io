...
var game = new Phaser.Game(width, height, Phaser.AUTO, 'lsd', { preload: preload, create: create, update: update });

function preload() {

    game.load.image('texture', 'willow.png');
...
function create() {
    ...
    filter.setResolution(height, height);
